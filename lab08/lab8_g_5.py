...
def check_binary_search_tree_(root, l = 0,r = 100):
    ...
    if root.data < l or root.data > r:
        return False
    return check_binary_search_tree_(root.left, l, root.data - 1) and check_binary_search_tree_(root.right, root.data + 1, r)
tree = Tree()
